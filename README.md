...
1. **The tactics editor** — author per-player routes, holds, and timing on the minimap (the same navmesh the engine resolves on), turning the dials + roles into a drawn play. Where "how owners build tactics" actually lives.
