...
1. **Phase 1 — done, and then some.** The vertical slice is complete and deep: own a club, set comp + tactics, resolve match-days, watch your matches, develop the squad across seasons, balance the books, and work the transfer market. **Gate met:** there's a real reason to play one more season.
...
3. **Per-map anchor tuning** — N-site support is done (Haven/Lotus field all three); now tune the other ten maps' anchors so they play as *balanced* as Ascent, not merely complete. Staying 2D.
