...
1. **Tactics editor (v2) — draw the play** — place each player's route, hold, and timing on the minimap (the same navmesh the engine resolves on) and re-sim live, turning the dials into authored geometry.
