...
**Transfer market — in (money now matters):** the balance has a purpose. A **Market** screen lists deterministic free agents, and `playerValue` prices them so that *unrealised potential in a young player* is the premium and *age past peak* is a discount — so a 19-year-old ceiling is the dearest thing on the board while an ageing 87-rated star sells cheap. Signing is a **swap**: you pay the net value difference against your same-role player, the one you replace is released, and your authored tactics remap onto the new player automatically. So the loop closes — earn money by winning, spend it to sign a prospect (and develop them) or buy an established star to win *now*, sell your ageing core to fund it.
