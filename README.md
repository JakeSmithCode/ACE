...
1. **Phase 1 — finish the slice.** HQ, season, watch-your-match, and the development tick are in. Remaining: a comp-builder screen, a finances tick, and authoring *your* club's plays from the HQ. **Gate:** a solo player wants one more match-day.
