...
1. **Finish round dynamics** — the last of the three: a **modeled retake** (post-plant, surviving defenders regroup on the spike to contest the defuse, with their own trade density). Adaptive mid-round reads land later as an **IGL** trait with the player model.
