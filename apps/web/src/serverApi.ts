...
export class AceServer {
  ...
  toggleWatch(handle: string, token: string): Promise<{ watchlist: string[]; error?: string }> { return this.post('/watchlist', { handle }, token); }
