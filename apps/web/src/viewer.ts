...
export class Viewer {
  ...
  private build() {
    ...
    info.innerHTML = `<h3><span class="b"></span>Match</h3><div class="devnote">Generated by <b>@ace/engine</b> from a seed. Every route is an A* path on Ascent's navmesh; every kill is an attribute duel resolved on line of sight. Click any round below to jump to it.</div>`;
